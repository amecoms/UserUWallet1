      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ShowAmountView(amountText:  inputBalance?.toStringAsFixed(2) ?? "", onTap: callBack),

            if(transactionType == TransactionType.withdrawRequest)
              ShowAmountView(
                amountText: '${PriceConverter.calculation(inputBalance, Get.find<SplashController>().configModel!.withdrawChargePercent, 'percent')?.toStringAsFixed(2)}',
                title: 'charge'.tr,
              ),
