...
import 'package:six_cash/view/base/paginated_list_view.dart';
      ...
      body: RefreshIndicator(
        ...
        child: GetBuilder<NotificationController>(
          builder: (notification) {
            return notification.notificationModel == null ? const NotificationShimmer() :  notification.notificationList.isNotEmpty ?
            PaginatedListView(
